...
class ModelTrainer:
    ...
    def train(self, 
              num_epochs: int,
              save_path: str = 'Minor Project/Facial Recognition Attendance Sysytem/models/inception_v3_face_recognition_model.pth'):
        """Train the model"""
...
def main():
    ...
    CONFIG = {
        ...
        'architecture': 'inception_v3',  # Changed default to ResNet50
        'device': 'cuda'
    }
